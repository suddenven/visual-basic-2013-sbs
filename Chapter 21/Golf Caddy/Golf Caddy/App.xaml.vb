...
Partial Public Class App
    ...
    Private Sub Application_Activated(ByVal sender As Object, ByVal e As ActivatedEventArgs)
        If PhoneApplicationService.Current.State.ContainsKey("Score") Then
            TotalScore = PhoneApplicationService.Current.State("Score")
        End If
        If PhoneApplicationService.Current.State.ContainsKey("Hole") Then
            CurrentHole = PhoneApplicationService.Current.State("Hole")
        End If
        'Global variables TotalScore and CurrentHole then used to restore
        'Golf Caddy UI settings when MainPage is loaded
    End Sub
    ...
    Private Sub Application_Deactivated(ByVal sender As Object, ByVal e As DeactivatedEventArgs)
        If PhoneApplicationService.Current.State.ContainsKey("Score") Then
            PhoneApplicationService.Current.State("Score") = TotalScore
        Else
            PhoneApplicationService.Current.State.Add("Score", TotalScore)
        End If
        If PhoneApplicationService.Current.State.ContainsKey("Hole") Then
            PhoneApplicationService.Current.State("Hole") = CurrentHole
        Else
            PhoneApplicationService.Current.State.Add("Hole", CurrentHole)
        End If
    End Sub
